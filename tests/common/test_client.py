    ...
    def get(self):
        if self.error:
            if self.handler:
                ...
                raise msgpackrpc.error.RPCError(self.error)
        else:
...
# When given arguments cannot be parsed, jubatus-rpc server returns error
# code 2
